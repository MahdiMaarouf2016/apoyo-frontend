...
export class NavService {
			...
			title: 'Pâtisserie', type: 'sub', megaMenu: true, active: false, children: [
				{
					title: 'Chocolats', type: 'sub', active: false, children: [
						...
						{ path: '/pages/portfolio/grid/three', title: 'P.A.G Drops', type: 'link' },
						{ path: '/pages/portfolio/grid/four', title: 'P.A.G Pépites', type: 'link' },
						{ path: '/pages/portfolio/masonry/grid/two', title: 'P.A.G Block', type: 'link' },
						{ path: '/pages/portfolio/masonry/grid/three', title: 'P.A.G Batonnets', type: 'link' },
						{ path: '/pages/portfolio/masonry/grid/four', title: 'Couverture', type: 'link' },
			...
			title: 'Emballage', type: 'sub', megaMenu: true, active: false, children: [
				...
				},
				{
					title: 'Divers', type: 'sub', active: false, children: [
						...
						{ path: '/home/vegetable', title: 'Bobinette', type: 'link' },
			...
			title: 'Cérémonie', type: 'sub', active: false, children: [
				{
					title: 'Anniverssaire', type: 'sub', active: false, children: [
						...
						{ path: '/pages/register', title: 'Masque ', type: 'link' },
						...
						{ path: '/pages/checkout', title: 'Bougie ', type: 'link' },
	...
	LEFTMENUITEMS: Menu[] = [
		...
		{
			path: '/home/fashion', title: 'A Propos', type: 'link'
		},
		{
			path: '/home/fashion', title: 'Contact', type: 'link'
		},
		{
			title: 'Connexion', type: 'sub', active: false, children: [
			  { path: '/pages/account/login', title: 'Connexion', type: 'link' },
			  { path: '/pages/account/register', title: 'Se déconnecter', type: 'link' }
