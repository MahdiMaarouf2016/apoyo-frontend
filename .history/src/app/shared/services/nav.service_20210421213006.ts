	...
	MENUITEMS: Menu[] = [
		...
		},
		{
			title: 'Pâtisserie', type: 'sub', megaMenu: true, badge: true, badgeText: '1', active: false, children: [
				{
					title: 'Chocolat', type: 'sub', active: false, children: [
						{
							title: 'Pâte à glacer', type: 'sub', active: false, children: [
								{ path: '/home/fashion', title: 'Pâte à glacer', type: 'link' },
								{ path: '/home/fashion-2', title: 'Drops', type: 'link' },
								{ path: '/home/fashion-2', title: 'Pépites', type: 'link' },
								{ path: '/home/fashion-2', title: 'Block', type: 'link' },
								{ path: '/home/fashion-3', title: 'Batonets', type: 'link' }
							]
						},
						{ path: '/pages/portfolio/grid/three', title: 'Chocolat de couverture', type: 'link' },
						{ path: '/pages/portfolio/grid/four', title: 'Crème à tartiner', type: 'link' },
